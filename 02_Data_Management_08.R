...
# 
# Author: Alejandro Amill
###############################################################################

rm(list=ls())
gc()
BRFSS.08<-read.csv(file="I:/ORP/Data/BRFSS/Rae/BRFSS2008.csv")
BRFSS.08 <- read.csv (file = "/media/truecrypt2/ORP/Data/BRFSS/Raw/BRFSS2008.csv")
...
write.csv(file="I:/ORP/Data/BRFSS/Managed/BRFSS08_DM.csv", BRFSS.08)
write.csv(file="/media/truecrypt2/ORP/Data/BRFSS/Managed/BRFSS08_DM.csv", BRFSS.08)
## Save image ##
save.image(file = "/media/truecrypt2/ORP/Data/BRFSS/Managed/BRFSS08_DM.RData")
